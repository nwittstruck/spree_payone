    ...
    class Base
      ...
      def initialize(options)
        if !!options[:use_global_account_settings]
          @merchant_id = Spree::Config[:payone_merchant_id]
          @payment_portal_id = Spree::Config[:payone_payment_portal_id]
          @payment_portal_key = Spree::Config[:payone_payment_portal_key]
          @sub_account_id = Spree::Config[:payone_sub_account_id]
          @test_mode = Spree::Config[:payone_test_mode]
        else
